...
const siteContent = {
  ...
  fr: {
    ...
    copy: {
      ...
      "hero.title": "Cuisine genereuse entre terre et mer, au port de Pempoul.",
      ...
      "info.note": "Pour confirmer le service du soir ou les jours feries, le plus simple reste d'appeler.",
  ...
  en: {
    ...
    copy: {
      ...
      "hero.title": "Generous French cooking between land and sea, right on Pempoul harbour.",
      ...
      "info.note": "To confirm evening service or holiday opening, the easiest option is still to call.",
